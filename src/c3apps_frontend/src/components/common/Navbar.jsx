    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link to="/" className="flex items-center group">
            <span className="text-xl md:text-2xl font-bold bg-gradient-to-br from-blue-400 to-purple-600 bg-clip-text text-transparent group-hover:from-blue-300 group-hover:to-purple-500 transition-all duration-300">C3Academy</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-2 md:space-x-4">
            ...
            <Link to="/my-learning" className={getLinkStyle('/my-learning')}>
      ...
      >
        <div className="px-4 pt-2 pb-4 space-y-2">
          ...
          <Link to="/my-learning" className={`${getLinkStyle('/my-learning')} w-full`}>
            <AcademicCapIcon className="h-5 w-5 mr-2" />
            <span>My Learning</span>
          </Link>
          <Link to="/wishlist" className={`${getLinkStyle('/wishlist')} w-full`}>
            <HeartIcon className="h-5 w-5 mr-2" />
            <span>Course List</span>
          </Link>
          <Link to="/admin/dashboard" className={`${getLinkStyle('/admin/dashboard')} w-full`}>
            <span>Admin</span>
          </Link>
          
          <div className="pt-2 border-t border-gray-800/50">
            <Link to="/profile" className={`${getLinkStyle('/profile')} w-full`}>
              <UserCircleIcon className="h-5 w-5 mr-2" />
              <span>Your Profile</span>
            </Link>
            <Link to="/settings" className={`${getLinkStyle('/settings')} w-full mt-2`}>
            ...
            <Link to="/login" className="flex items-center w-full px-3 py-2 mt-2 text-sm font-medium text-red-400 hover:text-red-300 hover:bg-red-500/20 rounded-lg transition-all duration-200">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
              </svg>
              <span>Sign out</span>
